...
def preprocess_quora_data(inputdir,
    ...
    with open(os.path.join(targetdir, "elmo_train_data.pkl"), "wb") as pkl_file:
    ...
    with open(os.path.join(targetdir, "elmo_dev_data.pkl"), "wb") as pkl_file:
        pickle.dump(data, pkl_file)
    ...
    # options_file = "../../config/preprocessing/elmo.json"
    # weight_file = "../../data/embeddings/elmo_2x4096_512_2048cnn_2xhighway_5.5B_weights.hdf5"
    # embed_matrix = preprocessor.build_embedding_matrix_elmo(options_file, weight_file)
    # with open(os.path.join(targetdir, "embeddings_elmo.pkl"), "wb") as pkl_file:
    #     pickle.dump(embed_matrix, pkl_file)
