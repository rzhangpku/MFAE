...
if __name__ == "__main__":
    default_config = "../../config/training/cqadup_training_bert.json"
    ...
    parser.add_argument("--checkpoint",
                        default=None,#os.path.dirname(os.path.realpath(__file__)) + '/data/checkpoints/cqadup/bert/' +"esim_{}.pth.tar".format(1),
