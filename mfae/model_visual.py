...
from .layers_visual import RNNDropout, Seq2SeqEncoder, SoftmaxAttention, LengthEncoder
...
class ESIM(nn.Module):
    ...
    def forward(self, premises, hypotheses):
        ...
        projected_premises, projected_hypotheses, importances = self._attention(encoded_premises, premises_mask,
        ...
        return logits, probabilities, importances
