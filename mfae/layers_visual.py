...
class SoftmaxAttention(nn.Module):
    ...
    def forward(self,
        ...
        """
        # dot attn
        enhanced_premises0, enhanced_hypotheses0, importances = self.dot_attn(premise_batch, premise_mask,
        ...
        return projected_premises, projected_hypotheses, importances
    ...
    def dot_attn(self, premise_batch, premise_mask,
        ...
        return enhanced_premises, enhanced_hypotheses, (similarity_matrix,
                                                        premise_importance, hypotheses_importance,
                                                        inter_premise_importance, inter_hypotheses_importance)
