...
class ESIM(nn.Module):
    ...
    def __init__(self,
        ...
        self.elmo = Elmo(options_file, weight_file, 1, requires_grad=False, dropout=self.dropout) #2
    ...
    def forward(self, premises_ids, hypotheses_ids):
        ...
        encoded_premises = premises['elmo_representations'][0]
        ...
        encoded_hypotheses = hypotheses['elmo_representations'][0]
