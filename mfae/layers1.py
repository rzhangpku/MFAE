...
class SoftmaxAttention(nn.Module):
    ...
    def __init__(self, hidden_size, dropout=0.5):
        ...
        self.liner = nn.Sequential(nn.Linear(hidden_size // 2 * 7, hidden_size * 4), nn.ReLU(), RNNDropout(p=dropout))
    ...
    def multi_importance(self, premise_importance, hypotheses_importance,
        ...
        premise_all = self.liner(torch.cat([attended_premises2, attended_premises3,
                                            attended_premises4, attended_premises5, attended_premises6,
                                            attended_premises7, attended_premises8], dim=-1))
        hypotheses_all = self.liner(torch.cat([attended_hypotheses2, attended_hypotheses3,
